...
module "secrets_manager" {
  ...
  secret_name     = "${var.cluster_name}-secrets-0"
  description     = "Secrets for EKS cluster ${var.cluster_name}"
  recovery_window = var.secret_recovery_window
...
module "iam" {
  ...
  secrets_manager_secret_arns   = [module.secrets_manager.secret_arn, "${module.secrets_manager.secret_arn}*"]
